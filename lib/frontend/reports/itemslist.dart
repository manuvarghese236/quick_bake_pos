...
class ItemsListReport extends StatefulWidget {
  final String token;
  final String userid;
  final String username;
  const ItemsListReport(
      {Key? key,
      required this.token,
  ...
  @override
  State<ItemsListReport> createState() => _ItemsListReportState();
}

class _ItemsListReportState extends State<ItemsListReport> {
  bool load = false;
