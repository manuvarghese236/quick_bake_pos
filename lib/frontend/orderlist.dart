...
class _OrderListState extends State<OrderList> {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 0), () async {
      ...
      final ByteData Orderdata = await rootBundle.load(
        'assets/images/logo2.png',
      );
      final Uint8List logoimgBytes = Orderdata.buffer.asUint8List();
      final dynamic logoimage = im.decodeImage(logoimgBytes);
      final ByteData Orderrowdata = await rootBundle.load(
        'assets/images/rowim.png',
      );
      final Uint8List logorowimgBytes = Orderrowdata.buffer.asUint8List();
      setState(() {
        loading = true;
  ...
  loadDataFromServer() async {
    ...
    dynamic Orderlistresponse = await OrderListApi.getlist(
    ...
    if (Orderlistresponse["status"] == "success") {
      setState(() {
        ...
        for (var element in Orderlist) {
          if (element["Order_id"].toString() == lastSelectOrderId) {
      ...
      setState(() {
        error = true;
        message = Orderlistresponse["message"].toString();
        loading = false;
      });
    }
  }
                          ...
                          child: TextField(
                              ...
                              onTap: () async {
                                ...
                                if (pickedDate != null) {
                                  ...
                                  final dynamic Orderlistresponse =
                                      await OrderListApi.getlist(
                                          SearchTermController.text,
                                          selectedDateCode,
                                  ...
                                  if (Orderlistresponse["status"] ==
                                    ...
                                    Get.snackbar("Failed",
                                        Orderlistresponse["message"].toString(),
                          ...
                          child: Orderlist.isEmpty
                              ...
                              : ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    bool selected = (lastSelectOrderId ==
                                    ...
                                    return ListTile(
                                      ...
                                      onTap: () {
                                        setState(() {
                                          selectedreceipt = Orderlist[index];
                                          paymentChange = false;
                                          lastSelectOrderId =
                                      ...
                                      title: Text(
                                        Orderlist[index]["id"].toUpperCase(),
                                        textAlign: TextAlign.start,
                                        style: const TextStyle(
                                            color: Colors.black,
                                            fontSize: 12,
                                          ...
                                          children: [
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "AED : ${SimpleConvert.safeDouble(Orderlist[index]["vat_amount"]).toStringAsFixed(2).toUpperCase()}",
                                                  textAlign: TextAlign.start,
                                                  style: const TextStyle(
                                                      color: Colors.green,
                                                      fontSize: 13,
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "AED : ${(SimpleConvert.safeDouble(Orderlist[index]["grand_total"]) - (SimpleConvert.safeDouble(Orderlist[index]["vat_amount"]))).toStringAsFixed(2).toUpperCase()}",
                                                  textAlign: TextAlign.start,
                                                  style: const TextStyle(
                                                      color: Colors.green,
                                                      fontSize: 13,
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "AED : ${SimpleConvert.safeDouble(Orderlist[index]["grand_total"]).toStringAsFixed(2)}",
                                                  textAlign: TextAlign.start,
                                                  style: const TextStyle(
                                                      color: Colors.green,
                                                      fontSize: 13,
                                            ...
                                            //     ),
                                            //     Text(
                                            //       "AED : ${SimpleConvert.safeDouble(Orderlist[index]["grand_total"]).toStringAsFixed(2).toUpperCase()}",
                                            //       textAlign: TextAlign.start,
                                            //       style: TextStyle(
                                            //           color: Colors.green,
                                            //           fontSize: 13,
                                                                ...
                                                                OrderListApi.printOrderWindows(
                                                                    ...
                                                                    imgrowdatabytes,
                                                                    {
                                                                      ...
                                                                      "total_without_vat": (SimpleConvert.safeDouble(selectedreceipt!["grand_total"]) -
                                                                              (SimpleConvert.safeDouble(selectedreceipt!["vat_amount"])))
                                                                          .toStringAsFixed(2)
                                                                          .toUpperCase(),
                                                                      "discount":
                                                                          selectedreceipt![
