...
//           await API.getCustomerQueryList("", widget.token);
//       print(customerdetailsresponse);
//       final dynamic customerdetailsid = await API.indexOfList(
//           customerdetailsresponse, widget.userdetails["default_customer_id"]);
//       print("Selected data");
...
//                                                                           print(
//                                                                               val);
//                                                                           final List<dynamic> searchresponse = await API.getItemsQueryList(
//                                                                               val,
//                                                                               "",
//                                                                               widget.token);
//                                                                           print(
...
//                                                                           } else {
//                                                                             print("This is search response");
//                                                                             print(searchresponse);
//                                                                             final data =
//                                                                                 {
//                                                                               'id': searchresponse[0]!.id,
//                                                                               'part_number': searchresponse[0].partnumber,
//                                                                               'description': searchresponse[0].description,
//                                                                               "brand_id": searchresponse[0].brandid,
//                                                                               "brand_name": searchresponse[0].brandname,
//                                                                               "rate": searchresponse[0].rate,
//                                                                               "quantity": searchresponse[0].quantity,
//                                                                               "warehouse_id": searchresponse[0].warehouseid,
//                                                                               "unit_name": searchresponse[0].unit_name,
//                                                                               "unit_id": searchresponse[0].unit_id,
//                                                                               "arr_units": searchresponse[0].arr_units,
//                                                                               "tax_code": searchresponse[0].tax_code,
//                                                                               "discount": searchresponse[0].discount,
//                                                                               "available_qty": searchresponse[0].availableqty
//                                                                             };
//                                                                             print(data);
//                                                                             setState(() {
//                                                                               itemdetails = data;
//                                                                               selectedunit = searchresponse[0].arr_units[0];
//                                                                               array_units = searchresponse[0].arr_units;
//                                                                               focusnode.unfocus();
...
//                                                                         if (value ==
//                                                                             null) {
//                                                                           return await API.getItemsQueryList(
//                                                                               "",
//                                                                               "",
//                                                                               widget.token);
//                                                                         } else {
...
//                                                                           title:
//                                                                               Text(
//                                                                             "${listdata!.partnumber.toUpperCase()} [ ${listdata.description.toUpperCase()} ]  [ ${listdata.availableqty.isEmpty ? "" : double.parse(listdata.availableqty).toString().toUpperCase()} ] ",
//                                                                             overflow:
...
//                                                                 print((double.parse((model.totalPrice)
//                                                                             .toString()) +
...
//                                                                               double.parse((model.totalvat).toString()))
//                                                                           .toStringAsFixed(2))) {
//                                                                     setState(
//                                                                         () {
//                                                                       mainloading =
...
//                                                                             ? ""
//                                                                             : (double.parse((model.totalPrice).toString()) + double.parse((model.totalvat).toString())).toStringAsFixed(
//                                                                                 2),
...
//                                                                             saveinvoiceresponse["total_amount"].toString(),
...
//                                                               // color:
//                                                               //     Colors.yellow,
//                                                               child: (double.parse((model.totalPrice)
//                                                                               .toString()) +
//                                                                           double.parse((model.totalvat)
//                                                                               .toString())) <=
//                                                                       0
...
//                                                                                   padding: const EdgeInsets.symmetric(vertical: 5),
//                                                                                   child: Text(
//                                                                                     (double.parse(receivedamountcontroller.text) - double.parse((double.parse((model.totalPrice).toString()) + double.parse((model.totalvat).toString())).toStringAsFixed(2))).toStringAsFixed(2),
//                                                                                     textAlign: TextAlign.start,
//                                                                                     style: TextStyle(color: Colors.red, fontSize: 15, fontWeight: FontWeight.w600, fontFamily: 'Montserrat'),
//                                                                                   ),
//                                                                                 ),
//                                                                               ],
//                                                                             ),
